...
ActiveRecord::Schema.define(version: 2019_06_01_203249) do
  ...
  create_table "collection_resources", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "resource_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "resource_id", null: false
